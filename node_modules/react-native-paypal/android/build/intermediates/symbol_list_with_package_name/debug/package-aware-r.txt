...
color edit_text_border_selected
color edit_text_border_unselected
color edit_text_default_color
...
dimen edit_text_border_padding
dimen edit_text_border_radius
dimen edit_text_border_width
dimen edit_text_padding
dimen fab_margin
dimen fab_margin_16
dimen fab_margin_2
...
dimen progressbar_height
dimen progressbar_width
...
drawable edit_text_border
drawable googleg_disabled_color_18
drawable googleg_standard_color_18
drawable ic_check_circle
drawable ic_checked_box
drawable ic_radio_button_unchecked
drawable ic_uncheck_box
drawable minus
...
id centerCrop
id centerInside
id challengeInfoHeaderTextView
id challengeInfoLabelTextView
id challengeInfoTextView
id checkbox
id checked
id chronometer
id classic
id codeEditTextField
id content
id contentPanel
id custom
id customPanel
...
id src_in
id src_over
id ss_submitAuthenticationButton
id standard
id start
id status_bar_latest_event_content
id strict_sandbox
id submenuarrow
id submitAuthenticationButton
id submit_area
id tabMode
...
id warningIndicator
id webviewUi
id whiteListCheckboxHolder
id whyInfoDecTextview
id whyInfoLableTextview
id wide
id wrap_content
...
integer landscape_initial_ratio
integer landscape_secondary_ratio
...
layout abc_tooltip
layout activity_html_ui_view
layout activity_multi_select_challenge_view
layout activity_oob_challenge_view
layout activity_otp_challenge_view
layout activity_single_select_challenge_view
layout challege_footer
layout challenge_labelview_cf
layout challenge_multiselect_body_view
layout challenge_oob_body_view
layout challenge_otp_body_view
layout challenge_single_selectbody
layout challenge_toolbar_cf
...
string issuer_image
string learn_more_about_auth
string link_description
string menu_description
string menubar_description
string menuitem_description
string need_some_help
string next
string payment_security
string processing
...
string secured_checkout
string singe_select_challenge_info
string spinbutton_description
string ss_challengeinfo_lable
...
style CardinalSDKTheme
style CardinalSDKTheme_ActionBar
style ChallengeToolbar_LabelText
...
style TextAppearance_Widget_Event_Toolbar_Title
style Theme
...
style ToolBarStyle
style ToolBarStyle_Base
style ToolBarStyle_Event
style Toolbar_TitleText
...
style challengeLabelText
style otpBodyText
style otpbody_resendBtn
style otpbody_verfyBtn
style redboxButton
